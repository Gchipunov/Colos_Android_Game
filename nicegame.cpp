...
int g_PlayerForwardKeyUp  = 0 ;
int g_PlayerForwardKeyDown  = 0 ;

int g_PlayerDownKeyUp  = 0 ;
int g_PlayerDownKeyDown  = 0 ;

int g_PlayerBackwardKeyUp  = 0 ;   //g_PlayerForwardKeyUp, g_PlayerBackwardKeyUp,g_PlayerDownKeyUp,g_PlayerUpKeyUp
int g_PlayerBackwardKeyDown  = 0 ;

int g_PlayerUpKeyUp  = 0 ;
...
//-------------------------------
	...
	float EnemyX=0.15f+0.6f;        //   <--- |
		...
		float EnemyY=PlayerY;
		float EnemyYEnd=PlayerYEnd;
	float LevelX;
	float LevelY;
...
g_PlayerForwardKeyDown =1;
	...
	g_PlayerUpKeyDown =1;//g_PlayerY = g_PlayerY + 0.01f;
	
		if (key == 87 || key == 119)//key w,W
	g_PlayerDownKeyDown =1;//g_PlayerY = g_PlayerY + 0.01f;
	
	//g_PlayerJumpKeyUp//
		
		if (key == 32)//key SPACEBAR
			{g_PlayerJumpKeyDown = 1;}//g_PlayerY = g_PlayerY + 0.01f;
		//else
		//    { g_PlayerJumpKeyDown = 0;}
...
g_PlayerBackwardKeyDown =0;
	...
	g_PlayerForwardKeyDown =0;
		...
		if (key == 83 || key == 115)//key s,S, fire?
	g_PlayerDownKeyUp =0;//g_PlayerY = g_PlayerY + 0.01f;
	...
	//g_PlayerJumpKeyUp//
		...
		if (key == 32)//key SPACEBAR
			{g_PlayerJumpKeyUp = 0;}//g_PlayerY = g_PlayerY + 0.01f;
	//	else
		//    { g_PlayerJumpKeyDown = 0;}
